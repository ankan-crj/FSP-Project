...
<head>
  ...
  <title>Photography Packages - Eventastic</title>
...
<body>
  ...
  <section class="packages">
    <h2>Choose Your Photography Package</h2>
    <div class="package-grid">
      ...
      <div class="package-card">
        ...
        <h3>Basic Package</h3>
        <p>4 hours coverage, 200 edited photos, online gallery access.</p>
        <div class="price">5,000</div>
        <form action="PhotographyServlet" method="post">
      ...
      <div class="package-card">
        ...
        <p>8 hours coverage, 500 edited photos, photo album, online gallery.</p>
      ...
      <div class="package-card">
        ...
        <p>Full day coverage, unlimited photos, 2 albums, video highlights.</p>
